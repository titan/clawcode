"""Persistent shell mixin: file-based IPC for long-lived bash (reference ``PersistentShellMixin`` aligned)."""
...
class PersistentShellMixin:
    ...
    def _temp_prefix(self) -> str:
        base = os.path.join(tempfile.gettempdir(), f"clawcode-persistent-{self._session_id}")
